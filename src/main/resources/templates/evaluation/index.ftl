        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-md-12 column">
                    ...
                    <form role="form" method="post" action="/personnel/evaluation/save" onsubmit="return onsubmitFun()">
                        ...
                        <div class="form-group">
                            <label>备注</label><input type="int" class="form-control" id="evaRemarks"
                                                    onclick="onClickRemarks()" name="evaRemarks" value="${(evaluation.evaRemarks)!''}"/>
                        </div>
