            ...
            <div class="row clearfix">
                        ...
                        <#if evaluationPageList.content??>
                            <#list evaluationPageList.content as evaluation>
                                <tr>
                                    ...
                                    <td><a href="/personnel/evaluation/index1?empId=${evaluation.empId}">修改</a></td>
                ...
                <div class="col-md-12 column">
                    <ul class="pagination pull-right"> <!-- 让分页居右-->
                        ...
                        <#else>
                            <li>
                                <a href="/personnel/evaluation/list1?page=${currentPage - 1}&size=${pageSize}">上一页</a>
                            </li>
                        </#if>
                        ...
                        <#list 1..evaluationPageList.getTotalPages() as index>
                            ...
                            <#if currentPage == index>
                                <li class="disabled">
                                    <a href="/personnel/evaluation/list1?page=${index}&size=${pageSize}">${index}</a>
                                </li>
                            <#else>
                                <li>
                                    <a href="/personnel/evaluation/list1?page=${index}&size=${pageSize}">${index}</a>
                        ...
                        <#else>
                            <li>
                                <a href="/personnel/evaluation/list1?page=${currentPage + 1}&size=${pageSize}">下一页</a>
                            </li>
                        </#if>
                        <!-- 下一页处理  end-->
                    </ul>
