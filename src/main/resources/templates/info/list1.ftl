            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12 column">
                    <ul class="pagination pull-right">  <#--让分页居右-->
                        ...
                        <#else>
                            <li>
                                <a href="/personnel/info/list1?page=${currentPage - 1}&size=${size}">下一页</a>
                            </li>
                        </#if>
                        <#--上一页处理 end-->
                        ...
                        <#--当前页面置灰-->
                            <#if currentPage == index>
                                <li class="disabled">
                                    <a href="/personnel/info/list1?page=${index}&size=${size}">${index}</a>
                                </li>
                            <#else>
                                <li>
                                    <a href="/personnel/info/list1?page=${index}&size=${size}">${index}</a>
                        ...
                        <#else>
                            <li>
                                <a href="/personnel/info/list1?page=${currentPage + 1}&size=${size}">上一页</a>
                            </li>
                        </#if>
                        <#-- 下一页处理 end-->
                    </ul>
