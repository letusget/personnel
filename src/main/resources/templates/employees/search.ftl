        ...
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-md-12 column">
                    ...
                    <form role="form" method="get" action="/personnel/employees/result2?depName=depName">
                        <div class="form-group">
                            <label>输入部门名称</label>
                    ...
                    <form role="form" method="get" action="/personnel/employees/result3?empSex=empSex">
                        <div class="form-group">
                            <label>输入员工性别</label>
                            <#-- <input type="text" class="form-control" id="productPrice" name="depName"/>-->
